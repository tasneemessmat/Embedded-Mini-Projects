 ...
 *
 * Description: Header file for the ultrasonic Driver using ATmega32 ICU driver
 *
...
/*
 * Description:
 * Function to 1. Send the trigger pulse by using Ultrasonic_Trigger function.
